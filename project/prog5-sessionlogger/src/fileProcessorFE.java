...
public class fileProcessorFE 
{
	public static void runPA4()
	{
		...
		{		
			...
			BE.LogChatAndPrint("Welcome to the ultimate business chatbot! Knowledgeable about Unity and Tupperware!\nPlease message what you would like to discuss :)\n\t");
			...
			while(true) //This code will run until the break statement in matcherStop.find()
			{
				...
				{
					BE.LogChatAndPrint("Hey, how are you doing today?\n\t");
				}
				...
				{
					BE.LogChatAndPrint("Please include either the name \'Unity\' or \'Tupperware\' in your input\n\t");
				}
